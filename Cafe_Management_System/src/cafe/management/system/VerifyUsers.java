...
public class VerifyUsers extends javax.swing.JFrame {
    ...
    public void getAllRecords(String email){
        DefaultTableModel dtm = (DefaultTableModel) tableVerify.getModel();
        dtm.setRowCount(0);
    ...
    private void initComponents() {
        ...
        tableVerify = new javax.swing.JTable();
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(506, 82, -1, -1));
        ...
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(599, 80, 254, -1));

        tableVerify.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        tableVerify.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tableVerify.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableVerifyMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tableVerify);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(26, 134, 1320, 554));
    ...
    private void tableVerifyMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableVerifyMouseClicked
        // TODO add your handling code here:
        int index = tableVerify.getSelectedRow();
        TableModel model = tableVerify.getModel();
    ...
    }//GEN-LAST:event_tableVerifyMouseClicked
    ...
    private javax.swing.JTable tableVerify;
